...
class PopupEnviarPedidoWidget extends StatefulWidget {
  const PopupEnviarPedidoWidget({super.key});
                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            'kred63vb' /* Enviar pedido ao vendedor */,
                          ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'hywgg8eu' /* Segue a lista de itens do seu ... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ClipRRect(
                                    ...
                                    child: Image.network(
                                      'https://preview.keenthemes.com/metronic8/demo1/assets/media/stock/ecommerce/209.gif',
                                      width: 70.0,
                                      height: 70.0,
                                      fit: BoxFit.cover,
                                    ),
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '60n0fqw5' /* Confirme o pedido e você será ... */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(
                        ...
                        Builder(
                          builder: (context) => Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await launchURL('https://wa.me/5548988605478');
                                showDialog(
                                  ...
                                  builder: (dialogContext) {
                                    return Dialog(
                                      ...
                                      child: NumeroDoPedidoWidget(),
                                    );
                                  },
                                ).then((value) => setState(() {}));
                              },
                              text: FFLocalizations.of(context).getText(
                                'e408bhw6' /* Enviar pedido */,
                              ),
