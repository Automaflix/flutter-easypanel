...
class EditarPerfilClienteWidget extends StatefulWidget {
  const EditarPerfilClienteWidget({super.key});

  @override
  State<EditarPerfilClienteWidget> createState() =>
...
class _EditarPerfilClienteWidgetState extends State<EditarPerfilClienteWidget>
  ...
  void initState() {
    ...
    _model.bairroEndClienteTextController ??= TextEditingController();
    _model.bairroEndClienteFocusNode ??= FocusNode();

    _model.cidadeEndClienteTextController ??= TextEditingController();
    _model.cidadeEndClienteFocusNode ??= FocusNode();

    _model.estadoEndClienteTextController ??= TextEditingController();
    _model.estadoEndClienteFocusNode ??= FocusNode();
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'zi46n4ch' /* Insira as informações abaixo p... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'yu0j3ftm' /* Carregue uma imagem aqui */,
                                                  ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .bairroEndClienteTextController,
                                          focusNode:
                                              _model.bairroEndClienteFocusNode,
                                          autofocus: false,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            hintText:
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .estadoEndClienteTextController,
                                          focusNode:
                                              _model.estadoEndClienteFocusNode,
                                          autofocus: false,
                                          obscureText: false,
                                          decoration: InputDecoration(
                                            hintText:
