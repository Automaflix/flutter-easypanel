...
class _HomeWidgetState extends State<HomeWidget> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().dadosUser.username == '') {
        _model.getuser = await UserGroup.getUserCall.call(
          token: currentAuthenticationToken,
        );
        setState(() {
          FFAppState().dadosUser = DadosUserStruct(
            userId: UserGroup.getUserCall.userId(
              (_model.getuser?.jsonBody ?? ''),
            ),
            lojista: UserGroup.getUserCall.lojista(
              (_model.getuser?.jsonBody ?? ''),
            ),
            phone: UserGroup.getUserCall.phone(
              (_model.getuser?.jsonBody ?? ''),
            ),
            cpf: UserGroup.getUserCall.cpf(
              (_model.getuser?.jsonBody ?? ''),
            ),
            username: UserGroup.getUserCall.username(
              (_model.getuser?.jsonBody ?? ''),
            ),
            nomeCompleto: UserGroup.getUserCall.nomeCompleto(
              (_model.getuser?.jsonBody ?? ''),
            ),
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'nnv46x35' /* Abaixo está um resumo da sua a... */,
                                            ),
                                            textAlign: TextAlign.start,
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            'Olá, ${FFAppState().dadosUser.username}',
                                                                    ...
                                                                    fadeOutDuration:
                                                                        const Duration(
                                                                            milliseconds:
                                                                                500),
                                                                    imageUrl:
                                                                        'https://themesbrand.com/velzon/html/default/assets/images/products/img-3.png',
                                                                    width: 40.0,
                                                                    height:
                                                                        40.0,
                                                                    fit: BoxFit
                                                                    ...
                                                                    fadeOutDuration:
                                                                        const Duration(
                                                                            milliseconds:
                                                                                500),
                                                                    imageUrl:
                                                                        'https://themesbrand.com/velzon/html/default/assets/images/products/img-4.png',
                                                                    width: 40.0,
                                                                    height:
                                                                        40.0,
                                                                    fit: BoxFit
                                                                    ...
                                                                    fadeOutDuration:
                                                                        const Duration(
                                                                            milliseconds:
                                                                                500),
                                                                    imageUrl:
                                                                        'https://themesbrand.com/velzon/html/default/assets/images/products/img-5.png',
                                                                    width: 40.0,
                                                                    height:
                                                                        40.0,
                                                                    fit: BoxFit
