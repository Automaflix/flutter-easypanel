                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '2jxl2hcv' /* Use o formulário abaixo para c... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              hintText:
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                'dzo6jyi2' /* Insira seu e-mail aqui... */,
                                              ),
                                              hintStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .bodySmall
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              't30v5fdy' /* Insira seu nome completo... */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodySmall
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              '90d3m4ul' /* Insira o nome da sua loja... */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodySmall
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              'h7udt0ka' /* Insira sua senha aqui... */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodySmall
                                        ...
                                        onPressed: () async {
                                          ...
                                          if ((_model.createUser?.succeeded ??
                                            ...
                                            await authManager.signIn(
                                              authenticationToken:
                                                  UserGroup.loginCall.token(
                                                (_model.createLogin?.jsonBody ??
                                                    ''),
                                              ),
                                            );
                                            setState(() {
                                              FFAppState().dadosUser =
                                                ...
                                                lojista:
                                                    UserGroup.loginCall.lojista(
                                                  (_model.createLogin
                                                          ?.jsonBody ??
                                                      ''),
                                                ),
                                                phone:
                                                    UserGroup.loginCall.phone(
                                                  (_model.createLogin
                                                          ?.jsonBody ??
                                                      ''),
                                                ),
                                                cpf: UserGroup.loginCall.cpf(
                                                  (_model.createLogin
                                                          ?.jsonBody ??
                                                      ''),
                                                ),
                                                username: UserGroup.loginCall
                                                    .username(
                                                  (_model.createLogin
                                                          ?.jsonBody ??
                                                      ''),
                                                ),
                                                nomeCompleto: UserGroup
                                                    .loginCall
                                                    .nomeCompleto(
                                                  (_model.createLogin
                                                          ?.jsonBody ??
                                            ...
                                            _model.createLoja = await LojaGroup
                                                .createLojaCall
                                                .call(
                                              nomeLoja: _model
                                                  .nomeLojaTextController.text,
                                              token: UserGroup.loginCall.token(
                                                (_model.createLogin?.jsonBody ??
                                                    ''),
                                              ),
                                              dataCriacao: NOitoNGroup
                                                  .createUserCall
                                                  .dataCriacao(
                                                (_model.createUser?.jsonBody ??
                                                    ''),
                                              ),
                                            );
                                            _shouldSetState = true;
